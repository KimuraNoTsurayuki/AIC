...
def createTable(n,descs,quants,tots,currency,tax):
	...
	#--------------------------------------------------------------------------------
	c.drawString(table_coords[0],table_coords[1]-y_offset_3-y_offset*(n+15/2)-y_offset_2*5,"Company address: Georgia, Tbilisi,")
	c.drawString(table_coords[0],table_coords[1]-y_offset_3-y_offset*(n+15/2)-y_offset_2*6,"Krtsanisi district, Rustavi highway,")
	c.drawString(table_coords[0],table_coords[1]-y_offset_3-y_offset*(n+15/2)-y_offset_2*7,"N19, building N3, floor N1, storeroom")
	c.drawString(table_coords[0],table_coords[1]-y_offset_3-y_offset*(n+15/2)-y_offset_2*8,"Company postal code: 0114")
